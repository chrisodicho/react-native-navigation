...
describe('LayoutTreeParser', () => {
    ...
    beforeEach(() => {
        ...
        (0, ts_mockito_1.when)(mockedUniqueIdProvider.generate((0, ts_mockito_1.anything)())).thenReturn('myUniqueId');
        uut = new LayoutTreeParser_1.LayoutTreeParser((0, ts_mockito_1.instance)(mockedUniqueIdProvider));
    });
    describe('parses into { type, data, children }', () => {
        ...
        it('bottom tabs', () => {
            ...
            expect((0, keys_1.default)(result)).toEqual(['id', 'type', 'data', 'children']);
